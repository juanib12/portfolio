          ...
          >
            <div className="projects_data">
              ...
              <div className="projects_data-info">
                ...
                <div className="projects_data-desc">
                  App donde podrás añadir, editar o eliminar tus notas y
                  marcarlas como completado.
                </div>
                <button>Ver más</button>
              </div>
            </div>
          ...
          >
            <div className="projects_data">
              ...
              <div className="projects_data-info">
                ...
                <div className="projects_data-desc">
                  App donde podrás añadir, editar o eliminar tus servicios para
                  tu negocio de servicio técnico.
                </div>
                <button>Ver más</button>
              </div>
            </div>
