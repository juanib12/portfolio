    ...
    <main className="bd-grid" id="sobremi">
      <section className="about" id="about">
        ...
        <div className="about_data_title">
          <h2>¿Quién soy?</h2>
          <span>
            Soy un apasionado <em style={{ color: "rgb(56 189 248)" }}>desarrollador fullstack</em > con un año de experiencia, enfocado especialmente en la creaci&oacute;n de soluciones web robustas y eficientes.
